...
int main() {
    ...
    char *destino = (char *)malloc(strlen(origen) + 1); // Asigna memoria para destino
    char *origen2 = "hola mundo";
    char *destino2 = (char *)malloc(strlen(origen2) + 1); // Asigna memoria para destino2

    size_t longitud = 11; // Ajusta la longitud a 11 para incluir el carácter nulo
