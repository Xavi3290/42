...
destino. A diferencia de strcpy, que no verifica límites y puede provocar desbordamientos 
...
int main() {
    ...
    size_t longitud = 7; // Ajusta la longitud a 11 para incluir el carácter nulo
